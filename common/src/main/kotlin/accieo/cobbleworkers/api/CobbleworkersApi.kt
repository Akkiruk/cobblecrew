...
object CobbleworkersApi {
    ...
    private val descriptions = mapOf(
        ...
        "beet_puller" to "Pulls mature beetroot and deposits it in chests.",
        ...
        "sculk_harvester" to "Breaks sculk blocks and deposits drops in chests.",
        ...
        "book_binder" to "Crafts books. Requires Cut + Psychic.",
        "candle_maker" to "Crafts candles. Requires Will-O-Wisp + String Shot.",
        "chain_forger" to "Forges chains. Requires Iron Head + Fire Spin.",
        "lantern_builder" to "Builds lanterns. Requires Flash Cannon + Iron Head.",
        "banner_creator" to "Creates random banners. Requires Cut + Sketch.",
        "deep_sea_trawler" to "Trawls deep sea for treasure. Requires Dive + Whirlpool.",
        "magma_diver" to "Dives into magma for rare materials. Requires Dive + Lava Plume.",
        "blast_furnace" to "Smelts ores at 2x efficiency. Requires Overheat + Iron Head.",
        "full_restore" to "Grants Regeneration II and clears negatives. Requires Heal Bell + Aromatherapy.",
