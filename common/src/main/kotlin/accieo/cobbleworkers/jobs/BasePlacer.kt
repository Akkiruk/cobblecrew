...
abstract class BasePlacer : Worker {
    ...
    override fun isAvailable(world: World, origin: BlockPos, pokemonId: UUID): Boolean {
        return findPlacementTarget(world, origin) != null
            && CobbleworkersInventoryUtils.findInputContainer(world, origin, ::itemPredicate) != null
    }
    ...
    override fun tick(world: World, origin: BlockPos, pokemonEntity: PokemonEntity) {
        ...
        when (phases.getOrDefault(pokemonId, Phase.IDLE)) {
            Phase.IDLE -> {
                val source = CobbleworkersInventoryUtils.findInputContainer(
            ...
            Phase.FETCHING -> {
                ...
                CobbleworkersNavigationUtils.navigateTo(pokemonEntity, source)
                if (CobbleworkersNavigationUtils.isPokemonAtPosition(pokemonEntity, source, 2.0)) {
